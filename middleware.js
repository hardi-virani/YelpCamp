...
module.exports.validateCampground = (req, res, next) => {
    ...
    // console.log(error);
    if (error) {
        //this is because if there will be no error then in object, there will only be only value property in it and not error property. Eg: {value:{campground:{title:'hardi',price:1}}}. Otherwise.......: {value:{campground:{title:'hardi',price:'-2'}},error:[Error[ValidationError]:"campground.price" must be greater than or equal to 0]{_original:{campground:[Object]},details:[[Object]]}}
